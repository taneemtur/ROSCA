...
const Distirbuting = (props:any) => {
    ...
    useEffect(() => {
        if(status == 3){
          props.setDistirbuting(true)
        } 
      }, [status]) 
    return (
        <div className="">
            {(status==3 && participantsAddresses && !participantsAddresses.includes(walletAddress)) &&
